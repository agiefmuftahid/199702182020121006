			...
			var s = $(r), // input element
				...
				f = {
					...
					editor: {
                         ...
                         * @void
                         */
						save: function(item, toBlob, callback, renderThumbnail) {
							var inPopup = item.popup && typeof item.popup.html !== "undefined";
							...
							var type = item.type || 'image/jpeg',
								...
								nextStep = function(exportDataUrl, img) {
									var data = !toBlob ? exportDataUrl : new Blob([window.atob(exportDataUrl.split(',')[1])], {type: type, encoding: 'utf-8'});
									
									inPopup || renderThumbnail ? f.thumbnails.renderThumbnail(item, true, img || exportDataUrl) : null;
							...
							if (n.editor.maxWidth || n.editor.maxHeight) {
								...
								img.onload = function() {
									...
									// resize canvas
									f.editor.resize(img, canvas2, n.editor.maxWidth || img.width, n.editor.maxHeight || img.height, true, false);
						...
						add: function(file, prop) {
							...
							if (n.editor && format == 'image')
								item.editor = {
									...
									save: function(callback, toBlob) {
										f.editor.save(item, toBlob, callback);
									}
								};
