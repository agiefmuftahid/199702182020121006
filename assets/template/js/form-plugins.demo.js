...
var handleDatepicker = function() {
    ...
    $('#datepicker-default4').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
    $('#datepicker-default5').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
	$('#datepicker-default6').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
	$('#datepicker-default7').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
	$('#datepicker-default8').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
	$('#datepicker-default9').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
	$('#datepicker-default10').datepicker({
        format: 'dd/mm/yyyy',
        todayHighlight: true,
        forceParse: false
    });
